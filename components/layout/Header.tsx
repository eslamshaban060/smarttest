...
// //               className={`absolute top-full mt-2 w-52 bg-card border border-white/[0.08] rounded-2xl shadow-2xl overflow-hidden ${isRTL ? "left-0" : "right-0"}`}
// //             >
// //               {/* user info */}
...
// //               className="fixed bottom-0 left-0 right-0 z-[70] md:hidden bg-card rounded-t-[28px] overflow-hidden pb-8"
// //             >
...
//         ${
//           mobile
//             ? "w-9 h-9 bg-white/[0.08] hover:bg-white/[0.14] text-white/70 hover:text-white"
//             : isDark
//               ? "w-9 h-9 bg-white/[0.07] hover:bg-white/[0.12] border border-white/[0.1] text-white/70 hover:text-white"
//               : "w-9 h-9 bg-primary/[0.08] hover:bg-primary/[0.14] border border-primary/[0.12] text-primary/70 hover:text-primary"
//         }
//       `}
//     >
    ...
    <button
      ...
      className={`flex items-center justify-center rounded-xl transition-all w-9 h-9 ${
        mobile
          ...
          : isDark
            ? "bg-white/[0.07] hover:bg-white/[0.12] border border-white/[0.1] text-white/70 hover:text-white"
            : "bg-primary/[0.08] hover:bg-primary/[0.14] border border-primary/[0.12] text-primary/70 hover:text-primary"
      }`}
    >
      {mounted && (
        <AnimatePresence mode="wait" initial={false}>
