...
//         {/* ── Sidebar ─────────────────────────────────────────────────── */}
//         <div
//           className={`w-80 bg-[#0a2540] border-${isRTL ? "l" : "r"} border-white/[0.07] flex flex-col flex-shrink-0 overflow-hidden transition-all duration-300 ${sidebarOpen ? "w-80" : "w-0"}`}
//         >
//           {/* sidebar header */}
