...
// //       .then((r) => r.json())
// //       .then((d) => {
// //         if (d.success) setEmbedUrl(d.embedUrl);
// //         else setEmbedUrl(null);
// //       })
...
// //           className="bg-[#00b4d8] text-white font-bold px-6 py-3 rounded-xl text-[14px] hover:bg-[#0096b4] transition-all"
// //         >
...
// //     >
// //       {/* ── TOP BAR ──────────────────────────────────────────────────────────── */}
// //       <header className="bg-[#0a2540] border-b border-white/[0.07] px-5 py-4 flex items-center justify-between flex-shrink-0 z-30">
// //         <div
...
// //               {courseTitle}
// //             </p>
// //             <p className="text-white/40 text-[11px] mt-0.5">{lessonTitle}</p>
// //           </div>
// //         </div>
...
// //                       </div>
// //                     ) : embedUrl ? (
// //                       /* ✅ iframe بيستخدم الـ proxy URL مش الـ YouTube URL مباشرة */
// //                       <iframe
// //                         key={activeLesson.id}
// //                         src={embedUrl}
...
// //                     >
// //                       <div className={isRTL ? "text-right" : ""}>
// //                         <p className="text-[#00b4d8] text-[12px] font-bold uppercase tracking-wide mb-1">
// //                           {t(
...
// //                     <p className="text-white/30 text-[14px]">
// //                       {t(
// //                         "No material for this lesson",
// //                         "لا يوجد ماتريال لهذا الدرس",
// //                       )}
// //                     </p>
// //                   )}
// //                 </div>
...
// //           {/* ALL DONE — final exam prompt */}
// //           {allDone &&
// //             course.finalExam &&
// //             course.enrollment.status !== "COMPLETED" &&
// //             view !== "finalExam" && (
// //               <div className="mx-6 mt-6 bg-gradient-to-br from-[#0a2540] to-[#0d3a6e] rounded-2xl p-6 border border-[#e9c46a]/20">
// //                 <div
// //                   className={`flex items-center gap-4 ${isRTL ? "flex-row-reverse" : ""}`}
// //                 >
...
// //             </h3>
// //             <div className="bg-white/[0.05] rounded-xl p-3.5 space-y-2">
// //               <div
...
// //                     isActive
// //                       ? `bg-[#00b4d8]/15 border-${isRTL ? "r" : "l"}-2 border-[#00b4d8]`
// //                       : "hover:bg-white/[0.04]"
...
// //               >
// //                 <div
// //                   className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 ${view === "finalExam" ? "bg-[#e9c46a]/20" : "bg-white/[0.06]"}`}
// //                 >
// //                   <GraduationCap
// //                     className={`w-4 h-4 ${view === "finalExam" ? "text-[#e9c46a]" : allDone ? "text-[#e9c46a]/60" : "text-white/20"}`}
// //                   />
// //                 </div>
...
// //     if (r.ok) {
// //       setResult(d);
// //       if (d.passed) setTimeout(onPassed, 2000);
// //     }
// //   }
...
// //               >
// //                 <span className="text-[#00b4d8] me-2">Q{qi + 1}.</span>
// //                 {qText}
// //               </p>
...
// //                         isSelected
// //                           ? "bg-[#00b4d8]/20 border-[#00b4d8]/50 text-white"
// //                           : "bg-white/[0.04] border-white/[0.08] text-white/60 hover:bg-white/[0.08] hover:text-white"
// //                       }`}
// //                     >
// //                       <div
// //                         className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-all ${isSelected ? "border-[#00b4d8] bg-[#00b4d8]" : "border-white/20"}`}
// //                       >
// //                         {isSelected && (
...
// //                         {["A", "B", "C", "D"][oi]}
// //                       </span>
// //                       <span className="text-[14px] font-medium">{optText}</span>
// //                     </button>
// //                   );
// //                 })}
// //               </div>
...
// //           }
// //           className={`w-full flex items-center justify-center gap-2 bg-[#00b4d8] hover:bg-[#0096b4] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl text-[15px] transition-all shadow-lg shadow-[#00b4d8]/20 ${isRTL ? "flex-row-reverse" : ""}`}
// //         >
// //           {submitting ? (
...
// //           )}
// //           {submitting
// //             ? t("Grading...", "جاري التصحيح...")
// //             : t("Submit Quiz", "تسليم الكويز")}
// //         </button>
// //       </div>
// //     </div>
// //   );
...
// //             {t(
// //               "Pass score: 60% · You get a certificate if you pass!",
// //               "نجاح: 60% · ستحصل على شهادة عند النجاح!",
// //             )}
// //           </p>
// //           <button
...
// //                 className={`text-white font-bold text-[15px] leading-relaxed ${isRTL ? "text-right" : ""}`}
// //               >
// //                 <span className="text-[#e9c46a] me-2">Q{qi + 1}.</span>
// //                 {qText}
// //               </p>
// //               <div className="space-y-2.5">
// //                 {q.options.map((opt, oi) => {
...
// //                       className={`w-full flex items-center gap-3 p-4 rounded-xl border text-left transition-all ${isRTL ? "flex-row-reverse text-right" : ""} ${
// //                         isSelected
// //                           ? "bg-[#e9c46a]/20 border-[#e9c46a]/50 text-white"
// //                           : "bg-white/[0.04] border-white/[0.08] text-white/60 hover:bg-white/[0.08] hover:text-white"
// //                       }`}
// //                     >
// //                       <div
// //                         className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${isSelected ? "border-[#e9c46a] bg-[#e9c46a]" : "border-white/20"}`}
// //                       >
// //                         {isSelected && (
// //                           <CheckCircle2 className="w-3.5 h-3.5 text-[#0a2540]" />
// //                         )}
// //                       </div>
// //                       <span className="text-white/40 font-bold text-[12px] flex-shrink-0 w-5">
// //                         {["A", "B", "C", "D"][oi]}
...
// //           onClick={submit}
// //           disabled={
// //             submitting || Object.keys(answers).length < exam.questions.length
// //           }
// //           className={`w-full flex items-center justify-center gap-2 bg-[#e9c46a] hover:bg-[#f0d080] disabled:opacity-50 disabled:cursor-not-allowed text-[#0a2540] font-bold py-4 rounded-xl text-[15px] transition-all shadow-lg ${isRTL ? "flex-row-reverse" : ""}`}
// //         >
// //           {submitting ? (
// //             <Loader2 className="w-5 h-5 animate-spin" />
// //           ) : (
...
// // //     if (!w) return;
// // //     w.document.write(
// // //       `<html><head><title>Certificate</title></head><body style="margin:0">${el.outerHTML}</body></html>`,
// // //     );
// // //     w.document.close();
...
// // //           <div className="absolute inset-5 border border-[#e9c46a]/25 rounded-sm pointer-events-none" />
// // //           {[
// // //             "top-4 left-4",
// // //             "top-4 right-4",
// // //             "bottom-4 left-4",
...
// // //               <div className="absolute inset-0 border-2 border-[#e9c46a]/50 rotate-45 m-1" />
// // //               <div className="absolute inset-0 flex items-center justify-center">
// // //                 <div className="w-2 h-2 bg-[#e9c46a]/40 rotate-45" />
// // //               </div>
// // //             </div>
// // //           ))}
// // //           <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(233,196,106,0.07),transparent_60%)]" />
// // //           <div className="relative z-10 h-full flex flex-col items-center justify-center px-16 py-10 text-center">
// // //             <div className="flex items-center gap-3 mb-6 w-full">
// // //               <div className="h-px flex-1 bg-gradient-to-r from-transparent to-[#e9c46a]/40" />
// // //               <div className="flex items-center gap-2 px-4">
// // //                 <Sparkles className="w-4 h-4 text-[#e9c46a]/80" />
// // //                 <span className="text-[#e9c46a]/70 text-[11px] tracking-[0.3em] uppercase font-medium">
// // //                   EN-AVM Academy
// // //                 </span>
// // //               </div>
// // //               <div className="h-px flex-1 bg-gradient-to-l from-transparent to-[#e9c46a]/40" />
// // //             </div>
// // //             <p className="text-[#e9c46a]/50 text-[11px] tracking-[0.4em] uppercase mb-2">
// // //               Certificate of Completion
// // //             </p>
// // //             <h1
// // //               className="text-white text-[40px] font-bold leading-tight mb-1"
// // //               style={{ fontFamily: "Georgia, serif" }}
// // //             >
// // //               شهادة إتمام
// // //             </h1>
// // //             <div className="flex items-center gap-3 my-5 w-56">
...
// // //             </p>
// // //             <div className="bg-white/[0.06] border border-[#e9c46a]/20 rounded-2xl px-8 py-4 mb-4">
// // //               <h2
// // //                 className="text-[#e9c46a] font-bold text-[20px]"
// // //                 style={{ fontFamily: "Georgia, serif" }}
// // //               >
// // //                 {courseTitle}
// // //               </h2>
...
// // //                 <div className="w-14 h-14 rounded-full border-2 border-[#e9c46a]/50 flex items-center justify-center bg-[#e9c46a]/10">
// // //                   <GraduationCap className="w-6 h-6 text-[#e9c46a]" />
// // //                 </div>
// // //                 <p className="text-[#e9c46a]/40 text-[9px] tracking-widest uppercase mt-1">
// // //                   Official Seal
// // //                 </p>
// // //               </div>
// // //               <div className="text-center">
// // //                 <p className="text-white/25 text-[10px] tracking-wide uppercase mb-1">
// // //                   Issued on
// // //                 </p>
...
//   // current user info for certificate
...
//     return (
//       <div className="min-h-screen bg-[#f4f6f9] flex flex-col items-center justify-center gap-4">
//         <p className="text-slate-500">{t("Not enrolled", "غير مسجّل")}</p>
//         <button
//           onClick={() => router.push(`/dashboard/courses/${courseId}`)}
...
//                       className={`flex items-center gap-2 px-4 py-2 rounded-xl text-[13px] font-semibold transition-all ${isRTL ? "flex-row-reverse" : ""} ${view === tab.key ? "bg-white/[0.12] text-white border border-white/[0.1]" : "text-white/40 hover:text-white/70 hover:bg-white/[0.05]"}`}
//                     >
//                       <tab.Icon className="w-4 h-4" />
//                       {tab.label}
//                       {tab.key === "quiz" &&
...
//               {view === "video" && (
//                 <div className="flex flex-col flex-1">
//                   {/* player container — no right-click, no text select */}
//                   <div
...
//                     ) : activeEmbedUrl ? (
//                       <>
//                         {/* transparent overlay prevents direct interaction with YT controls */}
...
//                             )}
//                           </button>
//                           <span className="text-white/60 text-[12px] font-medium select-none flex-1">
//                             {lessonTitle}
//                           </span>
//                           <button
//                             onClick={() => {
...
//                 >
//                   <div
//                     className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 transition-all ${done ? "bg-emerald-500/20" : isActive ? "bg-[#00b4d8]/20" : "bg-white/[0.06]"}`}
//                   >
//                     {done ? (
//                       <CheckCircle2 className="w-4 h-4 text-emerald-400" />
//                     ) : !lesson.unlocked ? (
...
// // ══════════════════════════════════════════════════════════════════════════════
// // CERTIFICATE MODAL — canvas-based PNG download
// // ══════════════════════════════════════════════════════════════════════════════
// function CertificateModal({
//   courseTitle,
//   userName,
...
//     if (!canvas) return;
//     const W = 1122,
//       H = 794; // A4 landscape px at 96dpi
//     canvas.width = W;
//     canvas.height = H;
...
//     ctx.lineWidth = 2;
//     ctx.beginPath();
//     ctx.arc(160, 615, 38, 0, Math.PI * 2);
//     ctx.stroke();
//     ctx.strokeStyle = "rgba(233,196,106,0.25)";
//     ctx.lineWidth = 1;
//     ctx.beginPath();
//     ctx.arc(160, 615, 30, 0, Math.PI * 2);
//     ctx.stroke();
//     ctx.fillStyle = "#e9c46a";
//     ctx.font = "bold 24px Arial";
//     ctx.fillText("✦", 160, 623);
//     ctx.fillStyle = "rgba(233,196,106,0.5)";
//     ctx.font = "9px Arial";
//     ctx.letterSpacing = "2px";
//     ctx.fillText("OFFICIAL SEAL", 160, 668);
//     ctx.letterSpacing = "0px";
...
//     ctx.lineWidth = 1;
//     ctx.beginPath();
//     ctx.moveTo(W - 250, 630);
//     ctx.lineTo(W - 80, 630);
//     ctx.stroke();
//     ctx.fillStyle = "rgba(255,255,255,0.3)";
//     ctx.font = "11px Arial";
//     ctx.textAlign = "center";
//     ctx.fillText("EN-AVM Academy", W - 165, 650);
//   }
